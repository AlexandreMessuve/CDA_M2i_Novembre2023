...
public class IHM {
    ...
    private void createComputer (){
        Identification identification = Identification.builder().iMacAddress("01:23:45:67:89:AB").ipAddress("168.169.0.1").build();
        Computer computer = Computer.builder().name("MyComputer").price(1200.50f).identification(identification).build();
